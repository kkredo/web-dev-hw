 ...
 * @author Eberhard Graether / http://egraether.com/  found this code online, not mine. Did make some changes
...
THREE.TrackballControls = function ( object, domElement ) {
	...
	this.rotateSpeed = 1.0; //changed speed

	this.zoomSpeed = 1.3; // changed speed

	this.panSpeed = 0.5; //changed speed
